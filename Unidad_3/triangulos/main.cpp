...
int main() {
    ...
    do {
        cout << "\nFractales\n";
        cout << "1. Triangulo de Sierpinski\n";
        cout << "2. Polvo de Cantor\n";
        ...
        switch (opcion) {
            case 1:
                s.iniciar();
                registros.push_back(s.obtenerDatos());
                cout << "Datos agregados. Registros pendientes: " << registros.size() << endl;
                break;
            case 2:
                c.iniciar();
                registros.push_back(c.obtenerDatos());
                cout << "Datos agregados. Registros pendientes: " << registros.size() << endl;
                break;
            case 3:
                guardarRegistros("triangulos", registros);
                break;
            case 4:
                continuar = false;
                cout << "Saliendo...\n";
